...
<footer>
	...
	<div id="footer">
		<div class="inner_footer">
			...
			<div class="company">
				<ul class="list">
					<li><a class="link" href="#">Jolly소개</a></li>
					<li><a class="link" href="#">Jolly소개영상</a></li>
					<li><a class="link" href="#" target="_blank">인재채용</a></li>
					<li><a class="link" href="#">이용약관</a></li>
					<li><a class="link emph" href="#">개인정보처리방침</a></li>
					<li><a class="link" href="#">이용안내</a></li>
				</ul>
				법인명 (상호) : 주식회사 Jolly <span class="bar">I</span> 사업자등록번호 : 000-00-0000
				<a href="#" target="_blank" class="link">사업자정보 확인</a> <br>
				통신판매업 : 제 2018-부산서면-0000 호 <span class="bar">I</span> 개인정보보호책임자 :
				신우경 <br> 주소 : 부산시 마음대로 16길 20, 졸리빌딩 B1 ~ 4F <span class="bar">I</span>
				대표이사 : 신우경 <br> 입점문의 : <a href="#" target="_blank" class="link">입점문의하기</a>
				<span class="bar">I</span> 제휴문의 : <a href="#" class="link">business@jollycorp.com</a>
				<br> 채용문의 : <a href="#" class="link">recruit@jollycorp.com</a>
				<br> 팩스 : 070 - 0000 - 0000 <span class="bar">I</span> 이메일 : <a
					href="#" class="link">help@jollycorp.com</a> <em class="copy">@
		...
		<div class="footer_link">
			<div class="authentication">
				<a href="#none"
					...
					class="logo">
					<p class="txt">
						[인증범위] Jolly 쇼핑몰 서비스 개발 ＊ 운영 <br> [유효기간] 2019.04.01 ~
						2022.03.31
					</p>
				</a> <a href="none"
